...
<div class="documents flex flex--gapped flex--column {['beige', 'bleu', 'vert'][index % 3]}">
  ...
  <div class="links flex flex--gapped">
    ...
    <div class="link">
      <a class="flex flex--column flex--spaced" href={link.fields.asset ? link.fields.asset.fields.file.url : (link.fields.external ? link.fields.destination : link.fields.destination ? localizeHref(link.fields.destination) : link.fields.destination)} target={(link.fields.external || link.fields.asset) ? '_blank' : undefined} download={link.fields.asset ? link.fields.asset.fields.file.fileName : undefined}>
